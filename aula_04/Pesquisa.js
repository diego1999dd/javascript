...
while (continua === 'S') {
    ...
    do {
        esporte = leia.questionInt('Digite o Esporte favorito i (1-FUT/2-VOL/3-BASQ/4-OUTROS): ')
    ...
    continua = leia.question("Deseja continuar (S/N)?").toUpperCase()//toUpperCase serve para converter para letras maiusculas
